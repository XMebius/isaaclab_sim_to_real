...
class aliengo_leg_cmd_lcmt(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(aliengo_leg_cmd_lcmt._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != aliengo_leg_cmd_lcmt._get_packed_fingerprint():
            raise ValueError("Decode error")
        return aliengo_leg_cmd_lcmt._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = aliengo_leg_cmd_lcmt()
    ...
    def _get_hash_recursive(parents):
        if aliengo_leg_cmd_lcmt in parents: return 0
    ...
    def _get_packed_fingerprint():
        if aliengo_leg_cmd_lcmt._packed_fingerprint is None:
            aliengo_leg_cmd_lcmt._packed_fingerprint = struct.pack(">Q", aliengo_leg_cmd_lcmt._get_hash_recursive([]))
        return aliengo_leg_cmd_lcmt._packed_fingerprint
    _get_packed_fingerprint = staticmethod(_get_packed_fingerprint)

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", aliengo_leg_cmd_lcmt._get_packed_fingerprint())[0]
