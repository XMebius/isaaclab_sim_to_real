...
int rc_command_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __int16_t_encode_array(buf, offset + pos, maxlen - pos, &this->R2, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int16_t_encode_array(buf, offset + pos, maxlen - pos, &this->R1, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int16_t_encode_array(buf, offset + pos, maxlen - pos, &this->L1, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int16_t_encode_array(buf, offset + pos, maxlen - pos, &this->L2, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int rc_command_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __int16_t_decode_array(buf, offset + pos, maxlen - pos, &this->R2, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int16_t_decode_array(buf, offset + pos, maxlen - pos, &this->R1, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int16_t_decode_array(buf, offset + pos, maxlen - pos, &this->L1, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int16_t_decode_array(buf, offset + pos, maxlen - pos, &this->L2, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x1490de8052c7213aLL;
